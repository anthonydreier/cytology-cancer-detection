...
from dataset import CytologyDataset, IDX_TO_LABEL, IMAGENET_MEAN, IMAGENET_STD
...
def main():
    dataset = CytologyDataset("data/train.csv", split="train", image_size=224)
    ...
    plt.axis("off")
    plt.tight_layout()
    out_path = RESULTS_DIR / "phase1_train_batch.png"
